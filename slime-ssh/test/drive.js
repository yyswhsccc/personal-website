...
(async () => {
  ...
  const t = await shell([
    ...
    ['top', 3000],
    ['vim', 3800],
    ['echo aHR0cHM6Ly95b25nc2hhbi5pcy1hLmRldi8jdGVybWluYWwK | base64 -d', 900],
    ['open "$(echo aHR0cHM6Ly95b25nc2hhbi5pcy1hLmRldi8jdGVybWluYWwK | base64 -d)"', 2200],
    ['macOS shortcut: open "$(echo aHR0cHM6Ly95b25nc2hhbi5pcy1hLmRldi8jdGVybWluYWwK | base64 -d)"', 2200],
    ['neofetch', 800],
    ['git push --force', 800],
    ['docker ps', 800],
    ['npm install', 1500],
  ...
  const checks = [
    ...
    ['echo decodes door',   'https://yongshan.is-a.dev/#terminal'],
    ['open opens the door', '🚪 opening the door…'],
    ['open one-click hint', '⌘-click, you are through'],
    ['open hands-free hint', 'this exact line at YOUR prompt'],
    ['open gives OSC8 clickable link', '\x1b]8;;https://yongshan.is-a.dev/#terminal\x07'],
